...
public class ShippingRateLoader {
  ...
  List<Rate> buildShippingRates() {
    ...
    shippingRates.add(writeShippingRate("tax", "+AmericanSamoa", valueOf(0.000)));
    ...
    shippingRates.add(writeShippingRate("tax", "DistrictofColumbia", valueOf(0.06)));
    shippingRates.add(writeShippingRate("tax", "FederatedStatesofMicronesia", valueOf(0.020)));
    ...
    shippingRates.add(writeShippingRate("tax", "MarshallIslands", valueOf(0.02)));
    ...
    shippingRates.add(writeShippingRate("tax", "NewHampshire", valueOf(0.000)));
    shippingRates.add(writeShippingRate("tax", "NewJersey", valueOf(0.06625)));
    shippingRates.add(writeShippingRate("tax", "NewMexico", valueOf(0.05125)));
    shippingRates.add(writeShippingRate("tax", "NewYork", valueOf(0.04)));
    shippingRates.add(writeShippingRate("tax", "NorthCarolina", valueOf(0.04750)));
    shippingRates.add(writeShippingRate("tax", "NorthDakota", valueOf(0.055)));
    shippingRates.add(writeShippingRate("tax", "NorthernMarianaIslands", valueOf(0.02)));
    ...
    shippingRates.add(writeShippingRate("tax", "PuertoRico", valueOf(0.000)));
    shippingRates.add(writeShippingRate("tax", "RhodeIsland", valueOf(0.07)));
    shippingRates.add(writeShippingRate("tax", "SouthCarolina", valueOf(0.06)));
    shippingRates.add(writeShippingRate("tax", "SouthDakota", valueOf(0.045)));
    ...
    shippingRates.add(writeShippingRate("tax", "VirginIsland", valueOf(0.065)));
    ...
    shippingRates.add(writeShippingRate("tax", "WestVirginia", valueOf(0.06)));
